...
<h1 class="title">DIREÇÃO +</h1>

<a href="index.php"><button type="button" class="style btn btn-info">Voltar</button></a> <br><br>

<a href="registerDirection.php"><button type="button" class="style btn btn-success">Adicionar Diretor</button></a> <br><br>
...
<table class="table table-hover">
    ...
    <?php
        ...
        $directions = $user->getAll();
        foreach ($directions as $direction):
    ?>

        <tr>
            <td><?= $direction['tname'];?></td>
            <td><?= $direction['cpf'];?></td>
            <td><?= $direction['date_nasc'];?></td>
            <td>
                <a href="alterInfoDirection.php?id=<?php echo $direction['id']; ?>">
                    <img src="assets/images/editar.png" alt="Editar" title="Editar" width="25px" height="auto">
                </a>
                <a href="deleteDirection.php?id=<?php echo $direction['id']; ?>">
